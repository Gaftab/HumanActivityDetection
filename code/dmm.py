...
def main():
    ...
    dmm_to_png(get_dmm(map_f, nframes), '../output/front_dmm.png')
    dmm_to_png(get_dmm(map_s, nframes), '../output/side_dmm.png')
    dmm_to_png(get_dmm(map_t, nframes), '../output/top_dmm.png')
